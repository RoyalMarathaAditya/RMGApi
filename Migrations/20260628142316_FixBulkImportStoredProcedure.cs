...
{
    /// <inheritdoc />
    public partial class FixBulkImportStoredProcedure : Migration
    {
        /// <inheritdoc />
        ...
        {
            // Restore the stored procedure from before this migration
            // (same as FixNullableColumnsAndStoredProcedure Up — current deployed state)
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS sp_ProcessEmployeeImport");
