...
{
    /// <inheritdoc />
    public partial class UpdatePracticeWiseReportSp : Migration
    {
        private const string DropSql = "DROP PROCEDURE IF EXISTS usp_GetPracticeWiseReport;";
...
";
        ...
        private const string OriginalCreateSql = @"
CREATE OR ALTER PROCEDURE usp_GetPracticeWiseReport
AS
BEGIN
    SET NOCOUNT ON;
...
";
        ...
        {
            migrationBuilder.Sql(DropSql);
            migrationBuilder.Sql(OriginalCreateSql);
        }
    }
}
