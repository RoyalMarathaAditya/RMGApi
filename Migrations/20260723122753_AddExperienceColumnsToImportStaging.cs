...
{
    /// <inheritdoc />
    public partial class AddExperienceColumnsToImportStaging : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                USING (VALUES 
                    ('a1000000-0000-0000-0000-000000000015', 'Experience prior to NV', 'PriorExperience', 'Experience prior to NV', 'decimal', 15, 'employee-import', 0, 1),
                    ('a1000000-0000-0000-0000-000000000016', 'Exp in NV', 'RelevantExperience', 'Exp in NV', 'decimal', 16, 'employee-import', 0, 1)
