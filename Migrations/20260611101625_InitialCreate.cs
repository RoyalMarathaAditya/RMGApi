        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectDetails_Locations_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectDetailsSkills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectDetailsSkills_ProjectDetails_ProjectDetailsId",
                        column: x => x.ProjectDetailsId,
                        principalTable: "ProjectDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectDetailsSkills_Skills_SkillId",
                        column: x => x.SkillId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectDetails_LocationId",
                table: "ProjectDetails",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectDetailsSkills_ProjectDetailsId",
                table: "ProjectDetailsSkills",
                column: "ProjectDetailsId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectDetailsSkills_SkillId",
                table: "ProjectDetailsSkills",
                column: "SkillId");
