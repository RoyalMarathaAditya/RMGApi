...
{
    /// <inheritdoc />
    public partial class FixBulkImportManagerLookup : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    ...
                    BEGIN TRY
                        ...
                        -- Uses LEFT JOIN with COALESCE: first tries matching against newly inserted employees,
                        -- then falls back to the preserved name-to-ID map from before the delete.
                        UPDATE e
