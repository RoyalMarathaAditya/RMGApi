    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Employee, EmployeeDto>()
                ...
                .ForMember(dest => dest.SubPractice, opt => opt.MapFrom(src => src.SubPractice != null ? src.SubPractice.Name : null))
                ...
                .ForMember(dest => dest.ReportingManagerName, opt => opt.MapFrom(src => src.ReportingManagerName ?? (src.ReportingManager != null ? src.ReportingManager.FullName : null)))
                .ForMember(dest => dest.PracticeHeadName, opt => opt.MapFrom(src => src.PracticeHeadName ?? (src.PracticeHead != null ? src.PracticeHead.FullName : null)))
            ...
            CreateMap<Project, ProjectDto>()
                ...
                .ForMember(dest => dest.CSMRevenueTypeName, opt => opt.MapFrom(src => src.CSMRevenueType != null ? src.CSMRevenueType.Name : null));
            #endregion
        }
    }
}
