...
{
    public class ProbableNextAssignmentService : IProbableNextAssignmentService
    {
        private readonly IProbableNextAssignmentRepository _repository;
        private readonly IMapper _mapper;

        public ProbableNextAssignmentService(IProbableNextAssignmentRepository repository, IMapper mapper)
        {
