...
{
    public class AgeingBucketService : IAgeingBucketService
    {
        private readonly IAgeingBucketRepository _repository;
        private readonly IMapper _mapper;

        public AgeingBucketService(IAgeingBucketRepository repository, IMapper mapper)
        {
