...
{
    public class BillingBucketService : IBillingBucketService
    {
        private readonly IBillingBucketRepository _repository;
        private readonly IMapper _mapper;

        public BillingBucketService(IBillingBucketRepository repository, IMapper mapper)
        {
