...
namespace HRMS.Api.Services
{
    ...
    {
        Task<ApiResponse<IEnumerable<EmployeeDto>>> GetAllAsync(string? fullName = null, Guid? practiceId = null, DateTime? doj = null, Guid? statusId = null, CancellationToken cancellationToken = default);
