...
{
    public class CurrentBillingStatusService : ICurrentBillingStatusService
    {
        private readonly ICurrentBillingStatusRepository _repository;
        private readonly IMapper _mapper;

        public CurrentBillingStatusService(ICurrentBillingStatusRepository repository, IMapper mapper)
        {
